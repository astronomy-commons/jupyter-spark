...
export declare class TagInput extends AbstractPureComponent2<ITagInputProps, ITagInputState> {
    static displayName: string;
    static defaultProps: Partial<ITagInputProps> & object;
    static getDerivedStateFromProps(props: Readonly<ITagInputProps>, state: Readonly<ITagInputState>): Partial<ITagInputState> | null;
